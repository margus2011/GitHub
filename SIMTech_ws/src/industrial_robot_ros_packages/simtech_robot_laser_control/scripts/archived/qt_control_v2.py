...
class QtControl(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        loadUi(os.path.join(path, 'resources', 'control_v2.ui'), self)
        ...
        self.auto_mode = 0 # Continuous-1, tracks-1
        ...
        # set parameters read from yaml file (load these rosparam in launch file)
