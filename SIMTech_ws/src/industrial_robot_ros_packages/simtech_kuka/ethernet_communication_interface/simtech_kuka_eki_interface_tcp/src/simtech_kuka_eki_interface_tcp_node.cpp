...
#include <simtech_kuka_eki_interface_tcp/SrvRobotCommand.h>
...
class NdKukaRobotInterface {
    ...
    public:
        ...
        simtech_kuka_eki_interface_tcp::KukaEkiHardwareInterface hardware_interface;
        ...
        bool cb_robot_command(simtech_kuka_eki_interface_tcp::SrvRobotCommand::Request  &req,
                              simtech_kuka_eki_interface_tcp::SrvRobotCommand::Response &res)
        {
            try{
...
{
  ros::init(argc, argv, "simtech_kuka_eki_interface_tcp");
  ...
  spinner.stop();
  ROS_INFO_STREAM_NAMED("simtech_kuka_eki_interface_tcp", "Shutting down.");
