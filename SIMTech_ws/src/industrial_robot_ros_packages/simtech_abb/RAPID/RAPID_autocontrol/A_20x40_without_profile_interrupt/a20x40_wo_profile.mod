...
LOCAL TRAP trap_in_stop_point
  ...
  WaitTime 10; !// wait for 10 seconds to let everything get ready
  ...
  routine_command:=2; ! set the routine_command to 2, which will let the ROS to process control mode
