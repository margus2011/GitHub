...
class PartMarkers():
    def __init__(self):
        ...
        self.mesh.set_color((0.0, 0.5, 1.0, 1.0))
...
class PathMarkers():
    def __init__(self):
        ...
        self.path = LinesMarker()
        self.path.set_frame('/workobject')
        self.path.set_color((0.0, 1.0, 0.0, 1.0))
        self.marker_array.markers.append(self.path.marker)
        self.laser = SegmentsMarker()
        self.laser.set_frame('/workobject')
        ...
        self.arrow.set_color((0, 0, 1.0, 1.0))
    ...
    def set_pose(self, pose):
        if pose is not None:
            ...
            self.arrow.set_color((0.0, 0.0, 1.0, 1.0))
        else:
            self.arrow.set_color((0.0, 0.0, 0.0, 1.0))
