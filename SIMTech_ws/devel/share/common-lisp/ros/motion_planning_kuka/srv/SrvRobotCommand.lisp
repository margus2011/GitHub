...
(cl:in-package motion_planning_kuka-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvRobotCommand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvRobotCommand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motion_planning_kuka-srv:<SrvRobotCommand-request> is deprecated: use motion_planning_kuka-srv:SrvRobotCommand-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <SrvRobotCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_planning_kuka-srv:command-val is deprecated.  Use motion_planning_kuka-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvRobotCommand-request>)))
  ...
  "motion_planning_kuka/SrvRobotCommandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand-request)))
  "Returns string type for a service object of type 'SrvRobotCommand-request"
  "motion_planning_kuka/SrvRobotCommandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvRobotCommand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvRobotCommand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motion_planning_kuka-srv:<SrvRobotCommand-response> is deprecated: use motion_planning_kuka-srv:SrvRobotCommand-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <SrvRobotCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motion_planning_kuka-srv:response-val is deprecated.  Use motion_planning_kuka-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvRobotCommand-response>)))
  ...
  "motion_planning_kuka/SrvRobotCommandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand-response)))
  "Returns string type for a service object of type 'SrvRobotCommand-response"
  "motion_planning_kuka/SrvRobotCommandResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand)))
  ...
  "motion_planning_kuka/SrvRobotCommand")