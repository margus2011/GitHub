...
(cl:in-package simtech_robot_laser_control-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SrvRobotCommand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvRobotCommand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simtech_robot_laser_control-srv:<SrvRobotCommand-request> is deprecated: use simtech_robot_laser_control-srv:SrvRobotCommand-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <SrvRobotCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simtech_robot_laser_control-srv:command-val is deprecated.  Use simtech_robot_laser_control-srv:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvRobotCommand-request>)))
  ...
  "simtech_robot_laser_control/SrvRobotCommandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand-request)))
  "Returns string type for a service object of type 'SrvRobotCommand-request"
  "simtech_robot_laser_control/SrvRobotCommandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SrvRobotCommand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SrvRobotCommand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simtech_robot_laser_control-srv:<SrvRobotCommand-response> is deprecated: use simtech_robot_laser_control-srv:SrvRobotCommand-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <SrvRobotCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simtech_robot_laser_control-srv:response-val is deprecated.  Use simtech_robot_laser_control-srv:response instead.")
  (response m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SrvRobotCommand-response>)))
  ...
  "simtech_robot_laser_control/SrvRobotCommandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand-response)))
  "Returns string type for a service object of type 'SrvRobotCommand-response"
  "simtech_robot_laser_control/SrvRobotCommandResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SrvRobotCommand)))
  ...
  "simtech_robot_laser_control/SrvRobotCommand")