...
// (in-package simtech_kuka_eki_interface.srv)
...
class SrvRobotCommandRequest {
  ...
  static datatype() {
    ...
    return 'simtech_kuka_eki_interface/SrvRobotCommandRequest';
  }
...
class SrvRobotCommandResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'simtech_kuka_eki_interface/SrvRobotCommandResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'simtech_kuka_eki_interface/SrvRobotCommand'; }
};
