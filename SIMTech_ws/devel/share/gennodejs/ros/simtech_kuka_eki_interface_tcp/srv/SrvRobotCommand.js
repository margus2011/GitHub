...
// (in-package simtech_kuka_eki_interface_tcp.srv)
...
class SrvRobotCommandRequest {
  ...
  static datatype() {
    ...
    return 'simtech_kuka_eki_interface_tcp/SrvRobotCommandRequest';
  }
...
class SrvRobotCommandResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'simtech_kuka_eki_interface_tcp/SrvRobotCommandResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'simtech_kuka_eki_interface_tcp/SrvRobotCommand'; }
};
